...
import com.github.shadowsocks.utils.tag
 ...
 */
val tag1="ShadowsocksConnection"
class ShadowsocksConnection(private var listenForDeath: Boolean = false) : ServiceConnection, IBinder.DeathRecipient {
    ...
    override fun onServiceConnected(name: ComponentName?, binder: IBinder) {
        ...
        try {
            Log.e(tag1,"onServiceConnected listenForDeath:"+listenForDeath)
    ...
    override fun onServiceDisconnected(name: ComponentName?) {
        Log.e(tag1,"onServiceDisconnected :")
        unregisterCallback()
    ...
    override fun binderDied() {
        ...
        Log.e(tag1,"binderDied :")
    }

    private fun unregisterCallback() {
        Log.e(tag1,"unregisterCallback :")
        val service = service
    ...
    fun connect(context: Context, callback: Callback) {
        ...
        Log.e(tag1,"connect :"+serviceClass.name)
        val intent = Intent(context, serviceClass).setAction(Action.SERVICE)
        context.bindService(intent, this, Context.BIND_AUTO_CREATE)
    }

    fun disconnect(context: Context) {
        Log.e(tag1,"disconnect :")
        unregisterCallback()
